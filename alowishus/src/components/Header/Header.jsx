...
const Header = () => {
    ...
    return (
        <header className="container mx-auto px-5 pt-6">
            {/* wrapper */}
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between gap-x-10">
                    <nav className="hidden md:flex items-center md:gap-x-5 lg:gap-x-10 font-jost font-medium lg:text-base text-eerie-black *:relative *:after:content-[''] *:after:absolute *:after:left-0 *:after:-bottom-0.5 *:after:w-0 *:after:h-0.5 *:after:bg-eerie-black *:after:transition-all *:after:duration-300 *:after:delay-75 *:hover:after:w-full">
                        <a href="#">Cafe Munu</a>
                        <a href="#">About Us</a>
                        <a href="#">Find Us</a>
                    ...
                    <div className="flex items-center justify-between">
                        {/* shopping box */}
                        <a href="#" className="rounded-full flex items-center justify-center max-sm:p-2 mr-2.5 lg:mr-5 sm:p-3 xl:p-4 bg-white hover:text-white hover:bg-eerie-black transition-all duration-300 delay-75 shadow-2xl z-0">
                        ...
                        <div className="max-md:hidden">
                            ...
                            <a href="#"className="bg-eerie-black hidden items-center justify-center lg:flex lg:py-3 xl:py-3.75 px-7.5 font-jost text-white lg:text-sm xl:text-base/6.5 font-medium rounded-full hover:bg-white hover:text-eerie-black transition-all duration-300 delay-75 shadow-2xl">
                                BUY GIFT VOUCHERS
                            </a>
                        </div>
                        {/* bars */}
