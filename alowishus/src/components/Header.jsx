        ...
        <header className="container mx-auto px-5 mt-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-x-10">
                    <nav className="space-x-10 font-medium text-base text-eerie-black *:relative *:after:content-[''] *:after:absolute *:after:left-0 *:after:-bottom-2 *:after:w-0 *:after:h-0.5 *:after:bg-eerie-black *:after:transition-all *:after:duration-300 *:after:delay-75 *:hover:after:w-full">
                        <a href="#">Cafe Munu</a>
                        <a href="#">About Us</a>
                        <a href="#">Find Us</a>
